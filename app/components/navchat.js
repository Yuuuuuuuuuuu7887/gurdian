const NavChat = () => {
  return (
    <div className="">
      <div className="bg-white fixed bottom-0 left-0 w-full h-[86px] text-2xl border-t-[1px] border-[#D4D4D4] flex items-center p-4 sm:p-2 md:p-4 lg:p-6">
        {/* Left SVG Icon (large one) */}
        <div className="flex-shrink-0 mr-4">
          {" "}
          {/* Use mr-4 for spacing */}
          <svg
            ...
            className="text-[#8D8B8B]" /* Use Tailwind class for fill */
          >
            <path
              ...
              fill="currentColor" /* Changed to currentColor for Tailwind fill */
            />
          </svg>
        </div>
        ...
        <div className="flex-grow">
          <form className="flex w-full gap-2 items-center">
            <div className="relative flex-grow border-[1px] border-[#8D8B8B] rounded-3xl focus-within:ring-2 focus-within:ring-blue-500">
              <input
                type="text"
                placeholder="พิมพ์ข้อความ"
                name="title"
                className="flex-grow p-2 pl-4 pr-12 rounded-3xl focus:outline-none w-full" /* w-full added for full width within its flex-grow container */
              />
              {/* Right SVG Icon (user) */}
              <div className="absolute right-0 top-1/2 -translate-y-1/2 pr-2 pointer-events-none">
                <svg
                  width="28" /* Adjusted size for better fit */
                  height="28" /* Adjusted size for better fit */
                  viewBox="0 0 36 36"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <g clip-path="url(#clip0_7_11)">
                    <path
                      d="M24 15C24 18.315 21.315 21 18 21C14.685 21 12 18.315 12 15C12 11.685 14.685 9 18 9C21.315 9 24 11.685 24 15Z"
                      fill="currentColor"
                    />
                    <path
                      fill-rule="evenodd"
            ...
            <button type="submit" className="flex-shrink-0">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="text-[#FF0303]" /* Added for fill color */
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
